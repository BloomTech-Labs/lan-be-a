...
app.get("/posts/flagged", async (req, res) => {
  Flag.getFlaggedPosts().then(async (distinctPosts) => {
...
app.get("/comments/flagged", async (req, res) => {
  Flag.getFlaggedComments().then(async (distinctComments) => {
...
app.get("/comments/:id", async (req, res) => {
  ...
  Comment.fetchRecent(post_id).then(async (distinctComments) => {
    const getFlaggedComments = async (list) => {
      return Promise.all(
        list.map(async (comment) => {
          let flaggedComment = { ...comment };
