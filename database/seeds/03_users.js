  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {id: 'isuh2gsef', email: 'tim@hotmail.com', display_name: 'tim', profile_picture: 'https://cdn.pixabay.com/photo/2016/07/27/08/03/child-1544790_960_720.jpg', track: 'web', onboarded: true, role_id: 1},
        {id: 'vnsfh7sf', email: 'brad@gmail.com', display_name: 'brad', profile_picture: 'https://cdn.pixabay.com/photo/2019/02/13/18/46/model-3994985_1280.jpg', track: 'web', onboarded: true, role_id: 3},
